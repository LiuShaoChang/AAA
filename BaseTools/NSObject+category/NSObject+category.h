...
typedef enum DATE_TYPE {
    DATE_TYPE_YEAR_MONTH_DAY_HOUR_MINUTE,
    DATE_TYPE_YEAR_MONTH_DAY,
    DATE_TYPE_MONTH_DAY_HOUR_MINUTE,
    DATE_TYPE_MONTH_DAY,
    DATE_TYPE_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND,
    DATE_TYPE_YEARMONTHDAY,
