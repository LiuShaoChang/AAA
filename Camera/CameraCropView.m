...
- (void)layoutSubviewsInitially {
    ...
    self.cropView.center = CGPointMake(self.frame.size.width / 2.0, self.frame.size.height / 2.0);
...
- (void)adjustRoundViewsFrame {
    ...
    self.bottomCoverView.frame = CGRectMake(0.0, self.cropView.origin.y + self.cropView.frame.size.height, self.frame.size.width, self.frame.size.height - self.cropView.frame.origin.y - self.cropView.frame.size.height);
}
...
- (void)adjustHitViewsFrame {
    ...
    self.rightHitView.frame = CGRectMake(self.topRightHitView.frame.origin.x, self.topRightHitView.frame.origin.y + self.topRightHitView.size.height, hitViewSideLength, self.cropView.frame.size.height - hitViewSideLength);
    self.rightBottomHitView.frame = CGRectMake(self.topRightHitView.frame.origin.x, self.rightHitView.frame.origin.y + self.rightHitView.size.height, hitViewSideLength, hitViewSideLength);
    self.leftHitView.frame = CGRectMake(self.topLeftHitView.frame.origin.x, self.topLeftHitView.frame.origin.y + self.topLeftHitView.size.height, hitViewSideLength, self.cropView.frame.size.height - hitViewSideLength);
    self.bottomLeftHitView.frame = CGRectMake(self.leftHitView.frame.origin.x, self.leftHitView.frame.origin.y + self.leftHitView.size.height, hitViewSideLength, hitViewSideLength);
